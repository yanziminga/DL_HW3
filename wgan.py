...
import models.wgan as models
import models.losses as losses
from utils.utils import generate_imgs, infiniteloop, set_seed
...
def train():
    if FLAGS.dataset == 'cifar10':
        ...
        print("Provide correct dataset--caifar10")
        
    dataloader = torch.utils.data.DataLoader(
        dataset, batch_size=FLAGS.batch_size, shuffle=True, num_workers=4,
        drop_last=True)

    net_G = models.Generator(FLAGS.z_dim).to(device)
    net_D = models.Discriminator().to(device)
